...
val expectedDaoCoinbaseTransactionOut = BitcoinTransactionOut(
        address = "1HWqMzw1jfpXb3xyuUZ4uWXY4tqL2cW47J", amount = "50",
...
val expectedDaoCoinbaseTransaction = BitcoinTransaction(
        ...
        blockTime = Instant.ofEpochSecond(1293623863).toString()
)
...
val expectedFirstTransactionInput = BitcoinTransactionIn(
        address = "1HWqMzw1jfpXb3xyuUZ4uWXY4tqL2cW47J", amount = "0.1", asm = "3046",
...
val expectedSecondTransactionInput = BitcoinTransactionIn(
        address = "1HWqMzw1jfpXb3xyuUZ4uWXY4tqL2cW47J", amount = "50", asm = "3046",
...
class BtcdToDaoTransactionConverterTest {
    ...
    val cacheManager = CacheManagerBuilder.newCacheManager(XmlConfiguration(ehcacheSettingsUri)).apply {
        init()
    }
    ...
    fun testConvertCoinbaseTransaction() {
        ...
        val daoCoinbaseTransaction = BitcoinTransactionConverter(cache).btcdTransactionToDao(
    ...
    fun testConvertRegularTransaction() {
        ...
        val daoInputTransactionById = listOf(
                BitcoinTransaction(
                        ...
                        outs = listOf(
                                ...
                                BitcoinTransactionOut(
                                        address = "1HWqMzw1jfpXb3xyuUZ4uWXY4tqL2cW47J", out = 1, amount = "0.1",
                                        asm = "041b0e8c2567c12536aa13357b79a073dc4444", required_signatures = 1
                                )
                        ), ins = emptyList(), blockTime = "", block_number = 10, fee = "0",
                        total_input = "0", total_output = "0", size = 3, lock_time = 10
                ),
        ...
        val regularTransaction = BitcoinTransactionConverter(cache).btcdTransactionToDao(

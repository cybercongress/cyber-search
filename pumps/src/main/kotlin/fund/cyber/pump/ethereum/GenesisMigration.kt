...
class GenesisMigration(
    ...
    override val entities: List<Pair<Class<CyberSearchItem>, CyberSearchItem>>
        get() {
            ...
            return genesis.accounts
                ...
                .flatMap { (key, value) ->
                    ...
                    val txByBlock = EthereumTxPreviewByBlock(tx)
                    val txAddr = EthereumAddressTransaction (
                        address = key,
                        fee = tx.fee,
                    ...
                    listOf(
                        Pair(EthereumTransaction::class.java as Class<CyberSearchItem>, tx as CyberSearchItem),
                        Pair(EthereumTxPreviewByBlock::class.java as Class<CyberSearchItem>, txByBlock as CyberSearchItem),
                        Pair(EthereumAddressTransaction::class.java as Class<CyberSearchItem>, txAddr as CyberSearchItem),
                        Pair(EthereumAddress::class.java as Class<CyberSearchItem>, addr as CyberSearchItem)
                    )
                }
        }
}

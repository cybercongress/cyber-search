...
class TxTraceConstructedForErroredTxTest : BaseTxTraceConverterTest() {
    ...
    private val expectedRootOperation = CallOperation(
        type = "call", from = "87268131fbcd127a0692ce6e0a714923fe6b67d1", input = "0xd1058e59", gasLimit = 68728,
        to = "d0a6e6c54dbc68db5db3a091b171a77407ff7ccf", value = BigDecimal("0E-18")
    )
